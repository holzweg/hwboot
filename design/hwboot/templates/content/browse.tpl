...
{/if}
    ...
    <form class="well"  name="browse" action={$browse.from_page|ezurl} method="post">
    ...
    {/if}
     <input class="btn btn-danger" type="submit" name="BrowseCancelButton" value="{'Cancel'|i18n( 'design/ezwebin/content/browse' )}" />
    </form>
