{default enable_print=true()}
    ...
    <link rel="apple-touch-icon" href={"bootstrap-apple-57x57.png"|ezimage} />
    <link rel="apple-touch-icon" sizes="72x72" href={"bootstrap-apple-72x72.png"|ezimage} />
    <link rel="apple-touch-icon" sizes="114x114" href={"bootstrap-apple-114x114.png"|ezimage} />
