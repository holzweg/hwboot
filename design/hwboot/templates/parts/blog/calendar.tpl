...
<div class="calendar well">
    ...
    <ul class="pager">
        <li class="previous">
            <a href={$url_back|ezurl} title="{'Previous month'|i18n('design/ezwebin/blog/calendar')}">&larr; {'Previous month'|i18n('design/ezwebin/blog/calendar')}</a>
        </li>
        <li class="next">
            <a href={$url_forward|ezurl} title="{'Next month'|i18n('design/ezwebin/blog/calendar')}">{'Next month'|i18n('design/ezwebin/blog/calendar')} &rarr;</a>
        </li>
    </ul>
