    ...
    <div class="calendar-tl"><div class="calendar-tr"><div class="calendar-bl"><div class="calendar-br">
                    <div class="content">
                        ...
                        <div class="month">
                            ...
                            <a href={$url_back|ezurl} title="{'Previous month'|i18n('design/ezwebin/blog/calendar')}">&#8249;&#8249;{'Previous month'|i18n('design/ezwebin/blog/calendar')}</a>

                                |
                            <a href={$url_forward|ezurl} title="{'Next month'|i18n('design/ezwebin/blog/calendar')}">{'Next month'|i18n('design/ezwebin/blog/calendar')} &#8250;&#8250;</a>

                            <h2>{$temp_ts|datetime( custom, '%F' )|upfirst()}&nbsp;{$temp_year}</h2>
                        </div>

                        <div class="table">
                            <table class="zebra-striped bordered-table"  cellspacing="0" border="0" summary="{'Calendar'|i18n('design/ezwebin/blog/calendar')}">
                                <tr class="top">
