...
<form class="well"  action={"rss/edit_export"|ezurl} method="post" name="RSSExport">
    ...
    <div class="clearfix">
        ...
        <input class="btn" type="submit" name="BrowseImageButton" value="{'Browse'|i18n( 'design/ezwebin/rss/edit_export' )}" title="{'Click this button to select an image for the RSS export. Note that images only work with RSS version 2.0'|i18n('design/ezwebin/rss/edit_export')}" />
    </div>
    {section name=RemoveImage show=eq( $rss_export.image_id, 0 )|not }
    <div class="block">
        <input class="btn" type="submit" name="RemoveImageButton" value="{'Remove image'|i18n( 'design/ezwebin/rss/edit_export' )}" title="{'Click to remove image from RSS export.'|i18n('design/ezwebin/rss/edit_export')}" />
    </div>
    {/section}
...
<div class="clearfix">
    ...
    <input class="btn" type="submit" name="Update_Item_Class" value="{'Set'|i18n( 'design/ezwebin/rss/edit_export' )}" title="{'Click this button to load the correct values into the drop-down fields below. Use the drop-down menu on the left to select the class.'|i18n('design/ezwebin/rss/edit_export')}" />
</div>
...
<input class="btn" type="submit" name="{concat( 'RemoveSource_', $Source:index )}" value="{'Remove this source'|i18n( 'design/ezwebin/rss/edit_export' )}" title="{'Click to remove this source from the RSS export.'|i18n('design/ezwebin/rss/edit_export')}" />
<hr />
{/section}

<input class="btn" type="submit" name="AddSourceButton" value="{'Add source'|i18n( 'design/ezwebin/rss/edit_export' )}" title="{'Click to add a new source to the RSS export.'|i18n('design/ezwebin/rss/edit_export')}" />

<div class="actions">
    <div class="clearfix">
        <input class="btn" type="submit" name="StoreButton" value="{'OK'|i18n( 'design/ezwebin/rss/edit_export' )}" title="{'Apply the changes and return to the RSS overview.'|i18n('design/ezwebin/rss/edit_export')}" />
        <input class="btn" type="submit" name="RemoveButton" value="{'Cancel'|i18n( 'design/ezwebin/rss/edit_export' )}" title="{'Cancel the changes and return to the RSS overview.'|i18n('design/ezwebin/rss/edit_export')}" />
    </div>
