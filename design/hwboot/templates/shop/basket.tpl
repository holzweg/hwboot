...
<div class="page-header">
    ...
    <form  class="form-stacked" method="post" action={"/shop/basket/"|ezurl}>
        ...
        <table class="class="zebra-striped""  width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr class="bglight">
                <td colspan="6"><input class="btn" type="submit" name="StoreChangesButton" value="{'Update'|i18n('design/ezwebin/shop/basket')}" /></td>
                <td colspan="1"><input class="btn" type="submit" name="RemoveProductItemButton" value="{'Remove'|i18n('design/ezwebin/shop/basket')}" /> </td>
            </tr>
