...
<div class="hero-unit">
    ...
    <form class="well"  method="post" action={"/shop/confirmorder/"|ezurl}>
        ...
        <div class="actions">
            <input class="btn" type="submit" name="CancelButton" value="{'Cancel'|i18n('design/ezwebin/shop/confirmorder')}" /> &nbsp;
            <input class="btn" type="submit" name="ConfirmOrderButton" value="{'Confirm'|i18n('design/ezwebin/shop/confirmorder')}" /> &nbsp;
        </div>
